    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝘽𝙊𝙎𝙎-𝙈𝘿 🥀",
            body: config.DESCRIPTION || "𝐵𝒪𝒮𝒮-𝑀𝒟 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/rfsmm0.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/923487690170",
